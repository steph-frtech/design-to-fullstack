...
import { changesetsTopRoutes } from "./changesets";
import { systemRoutes } from "./system";
import { behaviorsCatalogueRoutes } from "./spec";
...
const app = new Hono<{ Bindings: HttpBindings }>()
	...
	.route("/api/changesets", changesetsTopRoutes)
	.route("/api/system", systemRoutes)
	.route("/api/behaviors", behaviorsCatalogueRoutes)
	.all("/mcp", async (c) => {
